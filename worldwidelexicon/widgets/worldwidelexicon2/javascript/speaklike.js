// The SpeakLike Object. Provides access to SpeakLike API.
var speaklike = {
...
speaklikeAttachEvent(window, "load", false, function() { speaklike.init();  });
speaklikeAttachEvent(window, "unload", false, function() { speaklike.uninit() });
