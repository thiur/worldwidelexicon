...
class Jslib {
    ...
    function __construct()
    {
        ...
        log_message('debug', 'Jslib Class Initialized');
	}
 

	public function encodeURIComponent($string) {
	$result = "";
	...
	public function decodeURIComponent($string) {
	$result = "";
	for ($i = 0; $i < strlen($string); $i++) {
	$decstr = "";
	for ($p = 0; $p <= 8; $p++) {
	...
	public function encodeURI($string) {
	$result = "";
	for ($i = 0; $i < strlen($string); $i++) {
	...
	private function encodeURIbycharacter($char) {
	if ($char == "+") { return "%20"; }
	if ($char == "%21") { return "!"; }
	if ($char == "%23") { return "#"; }
	if ($char == "%24") { return "$"; }
	...
	public function decodeURI($string) {
	...
	private function decodeURIbycharacter($str) {
	...
	private function escapebycharacter($char) {
	if ($char == '+') { return '%20'; }
	if ($char == '%2A') { return '*'; }
	if ($char == '%2B') { return '+'; }
	if ($char == '%2F') { return '/'; }
	...
	private function unescapebycharacter($str) {
